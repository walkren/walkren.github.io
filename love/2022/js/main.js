...
const config = function () {
    ...
    return {
        ...
        wishShowTime: 600,
        postcard: '<h1>亲爱的小乖乖：</h1>\n' + '            <p>当你看到这里的时候，应该是我已经表白成功了吧，终于把你骗到手了，哈哈哈～ 从这里开始记录下我们在一起的每一分每一秒吧。</p>\n' + '            <p>关于表白这件事，我一直纠结于该怎么向你表达。隔着冰冷的屏幕，显然让你觉得不够正式，但面对面，我想即使我在心里排练了无数次的措辞，' + '都会在见到你的那一刻变得哑口无言，于是我选择向你当面告白之后，把想说的话放在这里告诉你。不知道你会不会喜欢这样的表白方式，但还是希望能够给你留下一个深刻而美好的记忆。</p>\n' + '            <p>从我们相识到现在，可能时间并不算长，因为疫情又耽误了很多次的见面，但是我们也算相互了解很多了，这个正式的表白反而有点晚了。' + '现在我终于可以大声且坚定的告诉你：<span style="font-weight: bold">我爱你</span> 。只要你愿意，我会永远爱你。</p>\n' + '            <p>每次和你一起散步的时候，我都会幻想以后可以光明正大的拥抱你牵你的手，毫不掩饰的说喜欢你爱你。虽然我们见面的次数并不算多，' + '但是和你相处的每时每刻，每一个细节，你的每一个微笑，都让我历历在目，深深的印在我的脑海里，每当想起你的时候都会让我的嘴角不自觉的上扬。</p>\n' + '            <p>如果你问我喜欢你什么，我想应该是喜欢你迷人的笑容，喜欢你好看的颜值和身材，最重要的是喜欢和你在一起的感觉，每当见到你就会有一种难以言表的开心。' + '每个人都将会老去，脆弱的外表终会被时间留下痕迹，但是唯一不变的是我对你真心，从见你的那一刻开始，就希望能够和你共度一生。</p>\n' + '            <p>从认识到现在，我们总共见过6次，其实每次见面我都是即期待又紧张，期待能够看到你，但又紧张在你面前表现得不是那么好。' + '回想每次见面我好像都是话比较少，所以也因此给你留下了害羞的印象吧。最让我印象深刻的就是第一次见面，你拿着一束花，' + '当你转过身的时候，仿佛是一种心动的感觉，你略带羞涩的把手里的花递给我。当时我就想，要是你能成为我的女朋友，和你结婚白头偕老应该是一件很幸福的事情吧。</p>\n' + '            <p>我算是一个比较孤独且慢热的人，有时候会害怕和人相处，不太会处理亲密关系，甚至共情能力也比较差。但是遇见你，' + '我却想用我最大的爱意去让你知道我爱你。可能我不太擅长用语言来表达感情，这段时间以来我和你分享也比较少，其实我也很想主动找你说话，' + '但是又怕我平淡的生活让你觉得无聊至极，所以我特别想见你，我想面对面应该更能表达我对你喜欢吧。很感谢你一直以来主动和我说话，' + '还和我分享你的日常，也正因为如此，我一定不会辜负你，不会让你失望。</p>\n' + '            <p>对于未来，我们或许还有很长的路要走，还会经历很多，在以后的相处里，我会尽我所能爱护你，照顾你，不让你受到伤害。' + '未来可能我们还会面临一些困难和考验，但是不管怎么样，我都会优先考虑你的感受。为了我们美好的未来，我也会更加努力，让你成为最幸福的女孩子。</p>\n' + '            <p>最后，用柏拉图的一句话结尾吧，你我本是一体，上帝将我们分开，在人间相遇。' + '世界这么大，能够遇到你，是我一生中最大的幸运，在这漫天星辰的夜空里，终于找到了属于我的那颗星星。</p>\n' + '            '
...
(function () {
    class MainStart {
        ...
        initProperty() {
            ...
            this.startTime.setFullYear(2022, 11, 3);
            this.startTime.setHours(20);
