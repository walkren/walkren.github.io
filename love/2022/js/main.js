...
const config = function () {
    ...
    return {
        ...
        wishShowTime: 600,
        postcard: '<h1>亲爱的小乖乖：</h1>\n' + '            <p>当你看到这里的时候，应该是我已经表白成功了吧，终于把你骗到手了，哈哈哈～ 从这里开始记录下我们在一起的每一分每一秒吧。不知道你会不会喜欢这样的表白方式，但我还是希望能够给你留下一个深刻而美好的记忆。</p>\n' + '            <p>从我们相识到现在，可能时间并不算长，现在表白或许有一点早，但是我更不想错过你，所以我想坚定的告诉你：<span style="font-weight: bold">我爱你</span> 。</p>\n' + '            <p>每次和你一起散步的时候，我都会幻想以后可以光明正大的拥抱你牵你的手，毫不掩饰的说喜欢你爱你。' + '虽然我们见面的次数并不算多，但是和你相处的每时每刻，每一个细节，你的每一个微笑，都让我历历在目，深深的印在我的脑海里，每当想起你的时候都会让我的嘴角不自觉的上扬。</p>\n' + '            <p>如果你问我喜欢你什么，我想应该是喜欢你迷人的笑容，喜欢你的好看的颜值和身材，但最重要的是和你在一起的感觉，不知道怎么形容，就感觉和你在一起就会有一种难以言表的开心。' + '每个人都将会老去，脆弱的外表终会被时间留下痕迹，但是唯一不变的是我对你真心，从见你的那一刻开始，就希望能够和你白头偕老，共度余生。</p>\n' + '            <p>其实每次见面我都是即期待又紧张，期待能够看到你，但又紧张在你面前表现得不是那么好。回想每次见面我好像都是话比较少，表现得也没有很好，所以也很担心会不会在你心里留下不好的印象。</p>\n' + '            <p>我算是一个比较孤独的人，有时候会很害怕和人相处，也不太会处理亲密关系，甚至共情能力比常人差一些，但是对于你，我却非常想和你待在一起，也会很憧憬我们一起走向婚姻的殿堂。</p>\n' + '            <p>对于未来，可能我看起来有点呆呆傻傻的，但是请相信我，我并没有表面上看起来那么脆弱，以后我会尽我所能爱护你，照顾你，不让你受到伤害。为你遮风挡雨，从始至终都守护在你身边。' + '或许以后也会遇到困难，失意或者诱惑，但是我依然会坚定的选择和你在一起。为了我们美好的未来，我也会更加努力，让你成为最幸福的女孩子。</p>\n' + '            <p>最后，用柏拉图的一句话结尾，你我本是一体，上帝将我们分开，在人间相遇。能够遇到你，是我一生中最大的幸运，相信我们的未来可期。</p>\n' + '            '
...
(function () {
    class MainStart {
        ...
        initProperty() {
            ...
            this.startTime.setFullYear(2022, 10, 2);
